...
def run_optimization():
    print(f"🚀 Starting Multi-threaded RSI Threshold Optimization...")
    ...
    print(f"🔍 Testing {len(tasks)} RSI combinations...")
    
    results = []
    with ProcessPoolExecutor() as executor:
        futures = [executor.submit(run_simulation, ob, os, df_final) for ob, os in tasks]
    ...
    opt_df.to_csv("optimization_results_rsi.csv", index=False)
    print("\n✅ Results saved to optimization_results_rsi.csv")
